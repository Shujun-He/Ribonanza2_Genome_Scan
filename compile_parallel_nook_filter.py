...
parser.add_argument('--organism', type=str, default="homo")
...
def parallel_process_files(pool, files, folder, window):
...
def main():
    ...
    for subfolder in os.listdir(folder):
        ...
        parquet_files = glob(f"{folder}/{subfolder}/*.parquet")
        
        # Process files in parallel
        
        dfs = parallel_process_files(pool, parquet_files, folder, window)
